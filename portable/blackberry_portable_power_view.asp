...
brand_type = "Blackberry "&pro_type
  ...
  <div id="wrap">
    ...
    <div id="content">
      <div id="main">
        ...
        <h2 id="position"><a title='Home' href='/index.asp'>Home</a> <span>/</span> <a  title='<%=pro_type%>' href='<%=pro_type_rule%>.asp'><%=pro_type%></a> <span>/</span> <a  title='<%=brand_type%>' href='<%=brand_type_rule%>.asp'><%=brand_type%></a> <span>/</span> <strong><%=pro_name%></strong></h2>
