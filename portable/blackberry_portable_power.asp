...
title = pro_brand&" 9700/9800/9000 "&pro_type&" - Lieko Mobile Phone "&pro_type
  ...
  <div id="wrap">
    ...
    <div id="content">
      <div id="main">
        ...
        <h2 id="position"><a title='Home' href='/index.asp'>Home</a> <span>/</span> <a  title='<%=pro_type%>' href='<%=pro_type_rule%>.asp'><%=pro_type%></a> <span>/</span> <strong><%=brand_type%></strong></h2>
        ...
        <div id="pros">
          ...
          <div class="list">
            ...
            <a class="more" href="<%=brand_type_rule%>_view.asp?name=<%=name&" "&number%>" title='<%=name%>'>See More</a>
          </div>
          <%
            rs.MoveNext()
          Next
