   ...
   <!--#include file="top.asp"-->
    ...
    <div id="content">
      <div id="main">
        ...
        <h2 id="position">Welcome to <a href="/index.asp" title="LIEKO Mobile Phone Case">LIEKO</a>&nbsp;/&nbsp;New Products</h2>

        <div id="pros">
          <h1>New Products</h1>
          <!--#include file="sharenew/prodlist_for_new.asp" -->
        </div>
