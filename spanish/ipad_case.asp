<%
Dim style, title, keywords, description, pro_brand, brand_type, pro_model, brand_model, pro_name, pro_brand_rule, brand_type_rule
style = "main"
pro_brand = "iPad"
pro_model = "2"
brand_type = pro_brand&" Protector"
If Request.QueryString("model") <> "" Then pro_model = Request.QueryString("model")
brand_model=pro_brand&" "&pro_model
pro_name = pro_brand&" "&pro_model&" Protector"
If pro_model="1" Then
  brand_model=pro_brand
  pro_name = pro_brand&" Protector"
End If
pro_brand_rule = Replace(LCase(pro_brand), " ", "_")
brand_type_rule = Replace(LCase(pro_brand&" Case"), " ", "_")
title = pro_name&" - Lieko iPad Protector"
