<div id="sidebar">
       <h2><a href="New_leather_case.asp">New leather case</a></h2>
	    <%
		'第一级分类
		sqllar="select * from PClass where gb='"&gbbase(0)&"' and ParentID=0 and id<>243 and id<>328 order by Orders asc"
      ...
      <h2><a href="###" title="LIEKO Contact" rel="nofollow">Contact</a></h2>
        <ul class="nav contact">
          <li><em>Email:</em> <a href="mailto:ceo@lieko.com">CEO@lieko.com</a></li>
