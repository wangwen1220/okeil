<div class="newbar"> <h2><a href="Newleather_sp.asp"> Leather case</a></h2></div>
<div class="newbar"> <h2><a href="ComboCase_sp.asp">Combo Case</a></h2></div>
...
<div id="sidebar">
      ...
      <h2><a href="#" title="<%=rs("classname_sp")%>"><%=rs("ClassName_sp")%></a></h2>
	  	<%
		'第二级分类
        ...
        <dl id="hot_selling" class="menu">
          <dt><a href="products_sp.asp?parentid=<%=rsmid("id")%>" title="<%=rsmid("classname_sp")%>"><%=rsmid("ClassName_sp")%></a></dt>
			  ...
			  %>
			  <dd><a href="products_sp.asp?parentid=<%=rstemp("id")%>" title="<%=rstemp("classname_sp")%>"><%=rstemp("ClassName_sp")%></a></dd>
			  <%
			  	rstemp.movenext
				loop
				end if
      ...
      <h2><a href="#" title="LIEKO Mobile Phone Cases Links">Enlaces</a></h2>
        <ul class="nav links">
		 <%
			set rs=Server.CreateObject("ADODB.RecordSet")
			sql= "select * from Link where gb='0'  order by xuhao desc "
      ...
      <h2><a href="###" title="LIEKO Contact" rel="nofollow">Contacto</a></h2>
        <ul class="nav contact">
          <li><em>Correo:</em> <a href="mailto:info@lieko.com">info@lieko.com</a></li>
          <li><em>MSN:</em> <a href="msnim:chat?contact=CEO@lieko.com">CEO@lieko.com</a></li>
          <li><em>Tel:</em> +86-769-81768061</li>
          <li>+86-769-85395956</li>
        </ul>
      </div>