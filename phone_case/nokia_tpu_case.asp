...
title = pro_name&" - "&pro_brand&" Case - Mobile Phone Case"
keywords = pro_name&", "&pro_type&", "&pro_brand&" Case, Cell Phone "&pro_type&", Mobile Phone Case"
description = "Lieko Co., Ltd for supply Cell Phone Case: "&pro_name&", "&pro_brand&" Case and Mobile Phone "&pro_type&"."
%>
    ...
    <div id="content">
      <div id="main">
        ...
        <div id="pros" class="case">
          ...
          Dim pros_rs, pros_title, pros_image, i
          Set pros_rs = Easp.db.GPR(0, Array(pro_type_rule&":title, image", "brand = '"&pro_brand&"'", "id Desc"))
          ...
          For i = 1 To pros_rs.PageSize
            ...
            Easp.W "<div><h3><a href='"&pros_rs("image")&"' title='"&pros_title&"'>"&pros_title&"</a></h3><a href='/public/view.asp?type="&pro_type&"&title="&pros_title&"&brand="&pro_brand&"' title='"&pros_title&"'><img src='"&pros_image&"' alt='"&pros_title&"' width='138' height='138' /></a></div>"
            pros_rs.MoveNext()
          Next
