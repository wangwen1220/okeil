<%
Dim style, title, keywords, description, pro_type, pro_type_rule, pro_brand, pro_model, pro_name, pro_name_rule
style = "pros"
pro_type = "Bamboo Case"
pro_brand = "iPhone"
pro_type_rule = Replace(LCase(pro_type), " ", "_")
pro_model = Trim(Request.QueryString("model"))
pro_name = pro_brand&" "&pro_model&" "&pro_type
    ...
    <div id="content">
      <div id="main">
        ...
        <div id="pros" class="case">
          ...
          Dim pros_rs, pros_title, pros_image, pros_no, oder_by, i
          oder_by = Easp.IIF(pro_model = "", "brand = '"&pro_brand&"'", "brand = '"&pro_brand&"' and model = '"&pro_model&"'")
          Set pros_rs = Easp.db.GPR(0, Array(pro_type_rule&":number, title, image", oder_by, "id desc"))
