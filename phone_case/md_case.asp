    ...
    <div id="content">
      <div id="main">
        ...
        <div id="pros" class="case">
          ...
          Dim pros_rs, pros_title, pros_image, i, oder_by, pros_brand
          oder_by = Easp.IIF(pro_brand = "", "", "brand = '"&pro_brand&"'")
          Set pros_rs = Easp.db.GPR(0, Array(pro_type_rule&":brand, title, image", oder_by, "id Desc"))
