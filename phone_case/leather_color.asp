      ...
      <div id="main">
        ...
        <div id="pros" class="case jqbox">
          ...
          <div<%if i > 20 then echo " class='hide'"%>>
            <h3>Leather <%=pros_model%></h3>
            <a href="<%=img_path&img%>" title="<%=pro_type&" "&pros_model%>"><img src="<%=img_path&"thumb\"&replace(img, ".jpg", "_thumb.jpg")%>" alt='<%=pros_model%>' /></a>
