    ...
    <div id="content">
      <div id="main">
        ...
        <div id="pros" class="case">
          ...
          Dim pros_rs, pros_title, pros_image, i, oderBy, pros_brand, pros_no
          oderBy = Easp.IIF(pro_brand = "", "", "brand = '"&pro_brand&"'")
          Set pros_rs = Easp.db.GPR(0, Array(pro_type_rule&":number, brand, title, image", oderBy, "id desc"))
          ...
          For i = 1 To pros_rs.PageSize
            ...
            Easp.W "<div><h3><a href='"&pros_rs("image")&"' title='"&pros_title&"'>"&pros_title&"</a></h3><a href='/public/view.asp?type="&pro_type&"&title="&pros_title&"&brand="&pros_brand&"' title='"&pros_title&"'><img src='"&pros_image&"' alt='"&pros_title&"' width='138' height='138' /></a><span class='number'>"&pros_no&"</span></div>"
            pros_rs.MoveNext()
          Next
